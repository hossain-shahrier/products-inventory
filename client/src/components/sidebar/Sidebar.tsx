    ...
    return (
        <div className={sidebarClassNames}>
            <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? "px-5" : "px-8"}`}>
                <Image
                    src="https://s3-inv-management.s3.ap-south-1.amazonaws.com/logo.png"
                    alt="edstock-logo"
                    width={27}
                    height={27}
                ...
                <h1 className={`${isSidebarCollapsed ? "hidden" : "block"
                    } font-extrabold text-2xl`}>STROSTOCK
                </h1>
            ...
            {/* Links */}
            <div className="flex-grow mt-8 px-3">
            ...
            <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
                <p className="text-center text-xs text-gray-500">&copy; 2024 Strostock</p>
            </div>
        </div>
    )
}
